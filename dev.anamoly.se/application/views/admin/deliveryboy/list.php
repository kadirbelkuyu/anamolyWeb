...
<section class="content">
    ...
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title"><?php echo _l("Delivery Boy"); ?> / <?php echo _l("List"); ?></h3>
            ...
            <table id="example1" class="table table-bordered table-striped datatable">
                ...
                foreach($data as $dt){
                    ...
                    <tr id="row_<?php echo $count; ?>">
                        ...
                        <td>
                            <div class="btn-group">
                                <a href="<?php echo site_url($controller."/login/"._encrypt_val($dt->$primary_key)); ?>" class="btn btn-info btn-xs"><i class="fa fa-lock"></i></a>
