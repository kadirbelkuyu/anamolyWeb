...
<div class="box">
        ...
        <?php
            ...
            echo _select("discount_types",(isset($offer_types))?$offer_types : array(),_l("Type"),array("value"),_get_post_back($field,'discount_types'),array(),array("form_group_class"=>"col-md-3","include_blank"=>_l("All")));
            ...
            <table id="example1" class="table table-bordered table-striped datatable">
                ...
                foreach($data as $dt){
                    ...
                    <tr id="row_<?php echo $count; ?>">
                        ...
                        <td><?php   if($dt->offer_type == "flat" || $dt->offer_type == "flatcombo"){
                                        echo $dt->number_of_products._l("@").$dt->offer_discount;
                                    }else{
                                        echo $dt->number_of_products . " + 1";
                                    }?>
                        </td>
                        <td><?php echo $dt->offer_type; ?></td>
