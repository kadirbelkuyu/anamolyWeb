...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <?php
        ...
        echo form_open();
        echo _input_field("username",_l("User Name"),'','text',array("placeholder"=>_l("User Name"),"data-validation"=>"required"));
    ...
    <a href="javascript:;"><?php echo _l("I forgot my password"); ?></a><br>
  </div>
  <!-- /.login-box-body -->
</div>
<!-- /.login-box -->
