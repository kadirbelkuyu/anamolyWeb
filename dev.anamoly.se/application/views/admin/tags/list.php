...
<section class="content">
    ...
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title"><?php echo _l("Tags"); ?> / <?php echo _l("List"); ?></h3>
        ...
        <div class="box-body">
            ...
            <table id="example1" class="table table-bordered table-striped datatable">
                ...
                <tr>
                    ...
                    <th><?php echo _l("Show on app home"); ?></th>
                ...
                foreach($data as $dt){
                    ...
                    <tr id="row_<?php echo $count; ?>">
                        ...
                        <td><?php echo $dt->tag_name_nl; ?></td>
                        <td><?php echo ($dt->show_on_app_home == 1) ? _l("Yes") : _l("No"); ?></td>
                        <td>
                            <div class="btn-group">
