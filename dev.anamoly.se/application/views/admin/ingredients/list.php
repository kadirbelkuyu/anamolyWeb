...
<section class="content">
    ...
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title"><?php echo _l("Ingredients"); ?> / <?php echo _l("List"); ?></h3>
            ...
            <table id="example1" class="table table-bordered table-striped datatable">
                ...
                foreach($data as $dt){
                    ...
                    <tr id="row_<?php echo $count; ?>">
                        ...
                        <td><span style="color:<?php echo ($dt->ingredient_colour != "") ? "#".$dt->ingredient_colour : "#000000"; ?>"><?php echo $dt->ingredient_name_nl; ?></span></td>
                        <td>
                            <div class="btn-group">
