<?php class Units_model extends CI_Model{
    ...
    function get($filter = array(),$search = "",$offcet="",$limit=""){
        ...
        if($search != ""){
            $this->db->or_like(array($this->table_name.'.unit_en'=>$search,
                                    $this->table_name.'.unit_ar'=>$search,
                                    $this->table_name.'.unit_nl'=>$search));
        }
