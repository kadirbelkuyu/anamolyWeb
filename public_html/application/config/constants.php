...
defined('REMOTE_URL')     OR define('REMOTE_URL','https://admin.anamoly.se');
...
defined('WEB_THEME_BASE')    OR define('WEB_THEME_BASE','themes/webshop');
defined('BASE_TEMPLATE')       OR define('BASE_TEMPLATE','admin/base_template/base_container');
defined('BASE_WEB_SHOTP_TEMPLATE')       OR define('BASE_WEB_SHOTP_TEMPLATE','webshop/common/common_template');
