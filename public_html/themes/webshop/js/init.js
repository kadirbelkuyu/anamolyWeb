...
function toastError(html){
  var toastHTML = html;
  M.toast({html: toastHTML, classes: 'red lighten-2 white-text'});
}
function toastSuccess(html){
  var toastHTML = html;
  M.toast({html: toastHTML, classes: 'teal lighten-2 white-text'});
}
function toastScript(html,type){
  var toastHTML = html;
	var classT = 'blue lighten-2 white-text';
	if(type == 'error'){
		classT = 'red error lighten-2 white-text';
	}else if(type == 'success'){
		classT = 'teal lighten-2 white-text';
	}
  M.toast({html: toastHTML, classes: classT});
}
