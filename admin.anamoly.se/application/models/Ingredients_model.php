<?php class Ingredients_model extends CI_Model{
    ...
    function get($filter = array(),$search = "",$offcet="",$limit=""){
        ...
        if($search != ""){
            $this->db->or_like(array($this->table_name.'.ingredient_name_en'=>$search,
                                    $this->table_name.'.ingredient_name_ar'=>$search,
                                    $this->table_name.'.ingredient_name_nl'=>$search));
        }
