<?php class Tags_model extends CI_Model{
    ...
    function get($filter = array(),$search = "",$offcet="",$limit=""){
        ...
        if($search != ""){
            $this->db->or_like(array($this->table_name.'.tag_name_en'=>$search,
                                    $this->table_name.'.tag_name_ar'=>$search,
                                    $this->table_name.'.tag_name_nl'=>$search,
                                    $this->table_name.'.tag_name_tr'=>$search,
                                    $this->table_name.'.tag_name_de'=>$search));
        }
