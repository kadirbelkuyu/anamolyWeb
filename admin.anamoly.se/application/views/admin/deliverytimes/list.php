...
<section class="content">
    ...
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title"><?php echo _l("Delivery Schedules"); ?> / <?php echo _l("List"); ?></h3>
            ...
            <table id="example1" class="table table-bordered table-striped datatable">
                ...
                foreach($data as $dt){
                    ...
                    <tr id="row_<?php echo $count; ?>">
                        ...
                        <td><?php echo $dt->days; ?></td>
                        <td><?php echo date(DEFAULT_TIME_FORMATE,strtotime($dt->from_time)); ?></td>
                        <td><?php echo date(DEFAULT_TIME_FORMATE,strtotime($dt->to_time)); ?></td>
                        <td>
                            <div class="btn-group">
