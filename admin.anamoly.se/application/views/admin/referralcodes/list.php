...
<section class="content">
    ...
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title"><?php echo _l("Referral Codes"); ?> / <?php echo _l("List"); ?></h3>
        ...
        <div class="box-body">
            ...
            <table id="example1" class="table table-bordered table-striped datatable">
                <thead>
                <tr>
					<th><?php echo _l("Referral Code"); ?></th>
                    <th><?php echo _l("Referral Type"); ?></th>
                ...
                foreach($data as $dt){
                    ...
                    <tr id="row_<?php echo $count; ?>">
                        ...
                        <td><?php echo $dt->valid_days; ?></td>
                        <td><?php echo ($dt->multi_usage == 1)? _l("Yes") : _l("No"); ?></td>
                        <td><?php echo ($dt->status == 1)? _l("Enable") : _l("Disable"); ?></td>
                        <td>
                            <div class="btn-group">
