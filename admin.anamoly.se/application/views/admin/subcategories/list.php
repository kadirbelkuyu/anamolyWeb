...
<section class="content">
    ...
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title"><?php echo _l("Sub Categories"); ?> / <?php echo _l("List"); ?></h3>
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                foreach($data as $dt){
                    ...
                    <tr id="row_<?php echo $count; ?>" data-ref="<?php  echo _encrypt_val($dt->$primary_key); ?>">
						...
						<td><?php if ($dt->sub_cat_image!="" && file_exists(CATEGORY_IMAGE_PATH."/crop/small/".$dt->sub_cat_image)){ ?>
						<img class="profileImage" src="<?php if(isset($dt->sub_cat_image) && $dt->sub_cat_image != ""){ echo base_url(CATEGORY_IMAGE_PATH."/crop/small/".$dt->sub_cat_image); } ?>" alt="<?php echo _l("Preview"); ?>" height="40"/>
						<?php } ?>
						</td>
